...
export default Dukcapil_Verification;
...
const Details = () => {
  ...
  return (
    <VStack textAlign="left" bgColor={bgColor} p="4" rounded="lg">
      ...
      <Text w="full">
        Endpoint: &nbsp;
        <Code>{` POST /v1/verification/philippines/dukcapil`}</Code>
        &nbsp;
      </Text>
    </VStack>
  );
...
curl -X 'POST' \
  '{{baseUrl}}/v1/verification/dukcapil' \
  ...
  const Pjsondata = `{
  $url = '{{baseUrl}}/v1/verification/dukcapil';
