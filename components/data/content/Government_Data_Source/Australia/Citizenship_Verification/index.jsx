...
curl -X 'POST' \
  ...
  const Presponse = `{
     $formData = [
    "image1" => new CURLFile('/path/to/your/image1.jpg', 'image/jpeg'),
    "image2" => new CURLFile('/path/to/your/image2.png', 'image/png')
];

// Define the base URL and endpoint
$baseUrl = "https://example.com"; // Replace with actual base URL
$endpoint = "/v1/verification/australia/certificate/citizenship";
